...
const dictionaries: Record<SupportedLocale, Record<TranslationKey, string>> = {
  en: {
    ...
    captureQuickEditing: 'Editing quick capture…',
    copy: 'Copy',
    export: 'Export',
    ...
    eyedropperMagnifier: 'Eyedropper magnifier',
    eyedropperClickToSample: 'Click to sample',
    eyedropperNoOpaqueColour: 'No opaque colour',
    eyedropperPreviewLoading: 'Scene is loading',
    eyedropperPreviewUnavailable: 'Preview unavailable',
  ...
  ru: {
    ...
    captureQuickEditing: 'Редактируем быстрый снимок…',
    copy: 'Копировать',
    export: 'Экспорт',
    ...
    eyedropperMagnifier: 'Лупа пипетки',
    eyedropperClickToSample: 'Нажмите, чтобы выбрать',
    eyedropperNoOpaqueColour: 'Нет непрозрачного цвета',
    eyedropperPreviewLoading: 'Сцена загружается',
    eyedropperPreviewUnavailable: 'Предпросмотр недоступен',
