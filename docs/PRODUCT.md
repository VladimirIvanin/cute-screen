...
- `REQ-CAP-001` — захват произвольной области из одного замороженного кадра, совпадающего с видимым результатом системного композитора; верхние, layered и аппаратно отрисованные окна не должны исчезать из результата.
