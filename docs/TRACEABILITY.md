...
| REQ-CAP-010 | M03 source validation, migration/recovery and repository-token tests | Tauri production mount decodes repository original     | implemented; runtime planned |
...
| REQ-EDT-006 | M03 command/session flush-handoff tests                              | cross-tool undo/redo E2E                               | implemented; runtime planned |
...
| REQ-LIB-001 | M03 repository transaction/fault-recovery tests                      | clean profile capture                                  | implemented; runtime planned |
...
| REQ-LIB-008 | M03 SQLite migration/restart and session-handoff tests               | restart/reopen Tauri E2E                               | implemented; runtime planned |
...
| REQ-QLT-005 | M03 journal, faults, atomic-file and constrained-path tests          | crash/restart recovery                                 | implemented; runtime planned |
