...
| REQ-ACT-005 | `lifecycle.rs` CLI/single-instance unit tests          | `window-lifecycle.e2e` (Linux/Win/mac artifacts) | implemented |
...
| REQ-UI-008  | `m02-lifecycle` window config unit test                | native-decoration Tauri smoke                    | implemented |
